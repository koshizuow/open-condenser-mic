...
# R_ZEN1 + Z_OSC1: moved right into the y=20 row, forming left-to-right V_OPA chain:
#   C1(38) → U2(57) → C2(74) → R_ZEN1(105) → Z_OSC1(120)
...
# V_OPA spine at x=80: C2, U2.OUT, R4, C6
